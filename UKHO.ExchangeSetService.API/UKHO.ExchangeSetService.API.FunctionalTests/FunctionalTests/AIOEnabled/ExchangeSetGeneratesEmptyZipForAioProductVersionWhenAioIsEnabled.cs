...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests.AIOEnabled
{
    ...
    class ExchangeSetGeneratesEmptyZipForAioProductVersionWhenAioIsEnabled : ObjectStorage
    {
        ...
        {
            var checkFile = FssBatchHelper.CheckforFileExist(DownloadedFolderPath, objStorage.Config.AIOConfig.ExchangeSetSerialAioFile);
        ...
        {
            var checkFile = FssBatchHelper.CheckforFileExist(Path.Combine(DownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder), objStorage.Config.ExchangeReadMeFile);
        ...
        {
            var checkFile = FssBatchHelper.CheckforFileExist(Path.Combine(DownloadedFolderPath, objStorage.Config.ExchangeSetProductFilePath), objStorage.Config.ExchangeSetProductFile);
        ...
        {
            var checkFile = FssBatchHelper.CheckforFileExist(Path.Combine(DownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder), objStorage.Config.ExchangeSetCatalogueFile);
