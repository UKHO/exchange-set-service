...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests.AIOEnabled
{
    ...
    class ExchangeSetGeneratesEmptyZipForInvalidCellForProductVersionWhenAioIsEnabled : ObjectStorage
    {
        ...
        public async Task VerifyEmptyEncExchangeSetForProductVersion()
        {
            ...
            var checkFileReadme = FssBatchHelper.CheckforFileExist(Path.Combine(EncDownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder), objStorage.Config.ExchangeReadMeFile);
            ...
            var checkFile = FssBatchHelper.CheckforFileExist(Path.Combine(EncDownloadedFolderPath, Config.ExchangeSetEncRootFolder), Config.ExchangeSetCatalogueFile);
            ...
            ////SERIAL.ENC 
            var checkFileSerial = FssBatchHelper.CheckforFileExist(EncDownloadedFolderPath, objStorage.Config.ExchangeSetSerialEncFile);
            ...
            //// INFO >> PRODUCT.TXT
            var checkFileProductTxt = FssBatchHelper.CheckforFileExist(Path.Combine(EncDownloadedFolderPath, objStorage.Config.ExchangeSetProductFilePath), objStorage.Config.ExchangeSetProductFile);
        ...
        public async Task VerifyEmptyAioExchangeSetForProductVersion()
        {
            ...
            //// ENC_ROOT >>> ReadmeTxtFile
            var checkFileReadme = FssBatchHelper.CheckforFileExist(Path.Combine(AioDownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder), objStorage.Config.ExchangeReadMeFile);
            ...
            //// ENC_ROOT >> Catalog.031
            var checkFile = FssBatchHelper.CheckforFileExist(Path.Combine(AioDownloadedFolderPath, Config.ExchangeSetEncRootFolder), Config.ExchangeSetCatalogueFile);
            ...
            ////SERIAL.AIO 
            var checkFileSerial = FssBatchHelper.CheckforFileExist(AioDownloadedFolderPath, objStorage.Config.AIOConfig.ExchangeSetSerialAioFile);
            ...
            //// INFO >> PRODUCT.TXT
            var checkFileProductTxt = FssBatchHelper.CheckforFileExist(Path.Combine(AioDownloadedFolderPath, objStorage.Config.ExchangeSetProductFilePath), objStorage.Config.ExchangeSetProductFile);
