...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests.AIOEnabled
{
    ...
    class ExchangeSetGeneratesEmptyZipForInvalidCellForProductIdentifierWhenAioIsEnabled : ObjectStorage
    {
        ...
        public async Task VerifyEmptyExchangeSetForProductIdentifier(List<string> product)
        {
            ...
            var downloadFileUrl = $"{objStorage.Config.FssConfig.BaseUrl}/batch/{batchId}/files/{objStorage.Config.ExchangeSetFileName}";
            ...
            var checkFileReadme = FssBatchHelper.CheckforFileExist(Path.Combine(DownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder), objStorage.Config.ExchangeReadMeFile);
            ...
            ////SERIAL.ENC 
            var checkFileSerial = FssBatchHelper.CheckforFileExist(DownloadedFolderPath, objStorage.Config.ExchangeSetSerialEncFile);
            ...
            //// INFO >> PRODUCT.TXT
            var checkFileProductTxt = FssBatchHelper.CheckforFileExist(Path.Combine(DownloadedFolderPath, objStorage.Config.ExchangeSetProductFilePath), objStorage.Config.ExchangeSetProductFile);
