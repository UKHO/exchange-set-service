...
{
    [TestFixture]
    public class ExchangeSetGenerateFilesForProductIdentifierWithNoValueForParameterexchangeSetStandard : ObjectStorage
    {
        ...
        public async Task SetupAsync()
        {
            ...
            var apiResponse = await ExchangeSetApiClient.GetProductIdentifiersDataAsync(DataHelper.GetProductIdentifiers(), null, accessToken: EssJwtToken, "");
        ...
        public async Task WhenICallProductIdentifiersApiWithNoValueForexchangeSetStandardParameter_ThenAProductTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallProductIdentifiersApiWithNoValueForexchangeSetStandardParameter_ThenAReadMeTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallProductIdentifiersApiWithNoValueForexchangeSetStandardParameter_ThenACatalogFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallProductIdentifiersApiWithNoValueForexchangeSetStandardParameter_ThenASerialEncFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallProductIdentifiersApiWithNoValueForexchangeSetStandardParameter_ThenEncFilesAreDownloaded()
        {
