...
{
    [TestFixture]
    public class ExchangeSetGenerateFilesForSinceDateTimeWithoutIsUnencryptedParameter : ObjectStorage
    {
        ...
        {
            var apiResponse = await ExchangeSetApiClient.GetExchangeSetBasedOnDateTimeWithoutIsUnencryptedParameterAsync(sinceDateTime, accessToken: EssJwtToken);
        ...
        public async Task WhenICallSinceDateTimeApiWithoutIsUnencryptedParameter_ThenAProductTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallSinceDateTimeApiWithoutIsUnencryptedParameter_ThenAReadMeTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallSinceDateTimeApiWithoutIsUnencryptedParameter_ThenACatalogFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallSinceDateTimeApiWithoutIsUnencryptedParameter_ThenASerialEncFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallSinceDateTimeApiWithoutIsUnencryptedParameter_ThenEncFilesAreDownloaded()
        {
