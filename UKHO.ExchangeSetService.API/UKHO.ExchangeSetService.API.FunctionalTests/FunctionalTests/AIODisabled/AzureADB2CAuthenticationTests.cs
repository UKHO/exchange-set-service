...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests.AIODisabled
{
    class AzureADB2CAuthenticationTests
    {
        ...
        public async Task SetupAsync()
        {
            ...
            var b2cAuthTokenProvider = new AzureB2CAuthTokenProvider();
        ...
        {
            var productVersionData = new List<ProductVersionModel> { DataHelper.GetProductVersionModelData("DE416080", 9, 6) };
