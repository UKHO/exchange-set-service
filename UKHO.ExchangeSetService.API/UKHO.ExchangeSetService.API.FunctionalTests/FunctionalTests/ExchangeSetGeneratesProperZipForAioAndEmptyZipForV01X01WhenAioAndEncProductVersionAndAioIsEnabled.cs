...
{
    [TestFixture]
    class ExchangeSetGeneratesProperZipForAioAndEmptyZipForV01X01WhenAioAndEncProductVersionAndAioIsEnabled
    {
        ...
        public async Task SetupAsync()
        {
            ...
            ProductVersionData.Add(DataHelper.GetProductVersionModelData("GB800001", 31, 32));
        ...
        public async Task WhenIDownloadAioZipExchangeSet_ThenEncFilesShouldNotBeAvailable()
        {
            ...
            foreach (var product in apiScsResponseData.Products)
            {
                ...
                if (productName.Equals("GB800001"))
                {
                    ...
                    {
                        await FileContentHelper.GetDownloadedEncFilesAsync(Config.FssConfig.BaseUrl, Path.Combine(AioDownloadedFolderPath, Config.ExchangeSetEncRootFolder), productName, editionNumber, updateNumber, FssJwtToken);
