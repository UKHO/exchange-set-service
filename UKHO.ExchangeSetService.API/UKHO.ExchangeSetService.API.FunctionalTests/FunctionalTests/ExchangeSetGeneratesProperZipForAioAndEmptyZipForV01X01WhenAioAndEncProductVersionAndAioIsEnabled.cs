...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests
{
    ...
    class ExchangeSetGeneratesProperZipForAioAndEmptyZipForV01X01WhenAioAndEncProductVersionAndAioIsEnabled : ObjectStorage
    {
        ...
        public void WhenIDownloadV01X01ZipExchangeSet_ThenAReadmeTxtFileIsAvailableAsync()
        {
            ...
            Assert.That(checkFile, Is.True, $"{Config.ExchangeReadMeFile} File not Exist in the specified folder path : {Path.Combine(EncDownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder)}");
        ...
        public async Task WhenIDownloadV01X01ZipExchangeSet_ThenEncFilesShouldNotBeAvailable()
        {
            ...
            Assert.That(Directory.Exists(Path.Combine(EncDownloadedFolderPath, "ENC_ROOT\\DE")),Is.False);
        }
        ...
        {
            // rhz debug start
            var testPath = Path.Combine(AioDownloadedFolderPath, objStorage.Config.ExchangeSetEncRootFolder);
