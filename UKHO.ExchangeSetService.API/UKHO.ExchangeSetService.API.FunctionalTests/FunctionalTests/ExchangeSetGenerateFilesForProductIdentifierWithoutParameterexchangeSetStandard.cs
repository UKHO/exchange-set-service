...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests
{
    ...
    public class ExchangeSetGenerateFilesForProductIdentifierWithoutParameterexchangeSetStandard : ObjectStorage
    {
        ...
        public async Task WhenICallProductIdentifiersApiWithoutexchangeSetStandardParameterAndWithMultipleProductIdentifiers_ThenAProductTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallProductIdentifiersApiWithoutexchangeSetStandardParameterAndWithMultipleProductIdentifiers_ThenAReadMeTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallProductIdentifiersApiWithoutexchangeSetStandardParameterAndWithMultipleProductIdentifiers_ThenACatalogFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallProductIdentifiersApiWithoutexchangeSetStandardParameterAndWithAValidProductIdentifiers_ThenASerialEncFileIsGenerated()
        {
