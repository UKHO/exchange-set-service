...
{
    [TestFixture]
    public class ExchangeSetGenerateFilesForProductVersionWithNoValueForParameterexchangeSetStandard : ObjectStorage
    {
        ...
        public async Task SetupAsync()
        {
            ...
            var apiResponse = await ExchangeSetApiClient.GetProductVersionsAsync(ProductVersionData, null, accessToken: EssJwtToken, "");
