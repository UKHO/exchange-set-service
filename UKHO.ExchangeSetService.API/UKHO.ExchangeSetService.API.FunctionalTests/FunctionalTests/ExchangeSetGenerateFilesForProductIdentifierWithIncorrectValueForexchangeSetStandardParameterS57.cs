...
{
    [TestFixture]
    public class ExchangeSetGenerateFilesForProductIdentifierWithIncorrectValueForexchangeSetStandardParameterS57 : ObjectStorage
    {
        ...
        public async Task SetupAsync()
        {
            ...
            var apiResponse = await ExchangeSetApiClient.GetProductIdentifiersDataAsync(DataHelper.GetProductIdentifiers(), null, accessToken: EssJwtToken, "S57");
