...
namespace UKHO.ExchangeSetService.API.FunctionalTests.FunctionalTests
{
    ...
    class ExchangeSetGenerateFilesForEncAndAioProductIdentifierWhenAioIsEnabled: ObjectStorage
    {
        ...
        public async Task WhenIDownloadAioZipExchangeSet_ThenEncFilesAreAvailable()
        {
            ...
            Assert.That((int)apiScsResponse.StatusCode, Is.Not.EqualTo(200), $"Incorrect status code is returned {apiScsResponse.StatusCode}, instead of the expected status 200.");
