...
{
    [TestFixture]
    public class ExchangeSetGenerateFilesForProductVersionWithIncorrectValueForIsUnencryptedParameter : ObjectStorage
    {
        ...
        public async Task WhenICallProductVersionApiWithIncorrectValueForIsUnencryptedParameter_ThenAProductTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallProductVersionApiWithIncorrectValueForIsUnencryptedParameter_ThenAReadMeTxtFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallProductVersionApiWithIncorrectValueForIsUnencryptedParameter_ThenACatalogFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public void WhenICallProductVersionApiWithIncorrectValueForIsUnencryptedParameter_ThenASerialEncFileIsGenerated()
        {
        ...
        [Test]
        [Category("QCOnlyTest-AIODisabled")]
        public async Task WhenICallProductVersionApiWithIncorrectValueForIsUnencryptedParameter_ThenEncFilesAreDownloaded()
        {
