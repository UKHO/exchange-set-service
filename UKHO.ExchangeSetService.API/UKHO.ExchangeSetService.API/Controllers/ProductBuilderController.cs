...
namespace UKHO.ExchangeSetService.API.Controllers
{
    ...
    public class ProductBuilderController : BaseController<ProductBuilderController>
    {
        private readonly IProductDataService productDataService;

        public ProductBuilderController(IHttpContextAccessor contextAccessor,
           ILogger<ProductBuilderController> logger,
        ...
        /// <param name="exchangeSetLayout">An optional exchangeSetLayout parameter determines the layout of the Exchange Set. If the value is standard, the Exchange Set returned will be of standard layout. If the value is large, the Exchange Set returned will be of s57 standard. The default value of exchangeSetStandard is s63, which means the Exchange Set returned will be of Large media layout.</param>
        ...
        [HttpPost]
        [Route("/productBuilder/productIdentifiers")]
        ...
        [SwaggerResponseHeader(statusCode: (int)HttpStatusCode.TooManyRequests, name: "Retry-After", type: JsonSchemaType.Integer, description: "Specifies the time you should wait in seconds before retrying.")]
        ...
        /// <response code="500">Internal Server Error.</response>
        [HttpPost]
        [Route("/productBuilder/productVersions")]
        [Consumes("application/json")]
        [Produces("application/json")]
        ...
        [SwaggerResponseHeader(statusCode: (int)HttpStatusCode.NotModified, name: "Date", type: JsonSchemaType.String, description: "Returns the current date and time on the server and should be used in subsequent requests to the productBuilder operation to ensure that there are no gaps due to minor time difference between your own and UKHO systems. The date format is in RFC 1123 format.")]
        [SwaggerResponse(statusCode: (int)HttpStatusCode.BadRequest, type: typeof(ErrorDescription), description: "Bad request.")]
        [SwaggerResponseHeader(statusCode: (int)HttpStatusCode.TooManyRequests, name: "Retry-After", type: JsonSchemaType.Integer, description: "Specifies the time you should wait in seconds before retrying.")]
        [SwaggerResponse(statusCode: (int)HttpStatusCode.InternalServerError, type: typeof(InternalServerError), description: "Internal Server Error.")]
