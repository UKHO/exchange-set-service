...
{
    public class SmallExchangeSetInstance : ISmallExchangeSetInstance
    {
        private readonly IOptions<EssFulfilmentStorageConfiguration> essFulfilmentStorageconfig;
        private Queue<int> queue;
        private readonly Object _lock = new Object();

        public SmallExchangeSetInstance(IOptions<EssFulfilmentStorageConfiguration> essFulfilmentStorageconfig)
        {
