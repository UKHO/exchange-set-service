...
namespace UKHO.ExchangeSetService.Common.HealthCheck
{
    public class EventHubLoggingHealthCheck : IHealthCheck
    {
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
        {
            ...
            {
                logger.LogError(EventIds.EventHubLoggingIsUnhealthy.ToEventId(), healthCheckResult.Exception, $"Event hub is unhealthy responded with error {healthCheckResult.Exception.Message}");
            }
