...
{    
    public class AzureBlobStorageService : IAzureBlobStorageService
    {
        ...
        public async Task<SalesCatalogueProductResponse> DownloadSalesCatalogueResponse(string scsResponseUri)
        {
            logger.LogInformation(EventIds.DownloadSalesCatalogueResponsDataStart.ToEventId(), "Sales catalogue response download start from blob for the {scsResponseUri}", scsResponseUri);
