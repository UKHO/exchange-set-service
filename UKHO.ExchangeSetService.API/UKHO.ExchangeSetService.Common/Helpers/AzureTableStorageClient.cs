...
namespace UKHO.ExchangeSetService.Common.Helpers
{
    ...
    {
        public async Task<ITableEntity> RetrieveAsync<TElement>(string partitionKey, string rowKey, string tableName, string storageAccountConnectionString) where TElement : ITableEntity
        {
        ...
        public async Task<ITableEntity> InsertOrMergeAsync(ITableEntity entity, string tableName, string storageAccountConnectionString)
        {
        ...
        public async Task<CloudTable> GetCloudTable(string tableName, string storageAccountConnectionString)
        {
        ...
        {
            var table = await GetCloudTable(tableName, storageAccountConnectionString);
