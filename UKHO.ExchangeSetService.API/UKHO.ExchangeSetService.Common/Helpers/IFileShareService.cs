...
namespace UKHO.ExchangeSetService.Common.Helpers
{
    public interface IFileShareService
    {
        ...
        Task<SearchBatchResponse> GetBatchInfoBasedOnProducts(List<Products> products,string batchId, string correlationId, CancellationTokenSource cancellationTokenSource, CancellationToken cancellationToken);
