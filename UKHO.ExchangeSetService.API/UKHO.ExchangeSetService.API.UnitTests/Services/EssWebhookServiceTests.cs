...
namespace UKHO.ExchangeSetService.API.UnitTests.Services
{
    ...
    public class EssWebhookServiceTests
    {
        ...
        public void Setup()
        {
            ...
            service = new EssWebhookService(fakeAzureTableStorageClient, fakeAzureStorageService, fakeAzureBlobStorageClient, fakeEnterpriseEventCacheDataRequestValidator, fakeCacheConfiguration, fakeLogger, fakeEssFulfilmentStorageConfig, fakefileShareServiceCache);
        }
        ...
        [Test]
        public async Task WhenInvalidRequestDataInUpsertSearchAndDownloadCacheData_ThenReturnResponseFalse()
        {
            ...
            await service.UpsertSearchAndDownloadCacheData(GetInvalidCacheRequestData(), FakeCorrelationId);
            ...
            A.CallTo(fakeLogger).Where(call => call.Method.Name == "Log"
              ...
              && call.GetArgument<EventId>(1) == EventIds.UpsertSearchAndDownloadInvalidCacheDataFoundEvent.ToEventId()
        ...
        [Test]
        public async Task WhenNoS63CacheDataExistsInUpsertSearchAndDownloadCacheData_ThenReturnResponseFalse()
        {
            ...
            await service.UpsertSearchAndDownloadCacheData(GetCacheRequestData(fakeCacheConfiguration.Value.S63CacheBusinessUnit), FakeCorrelationId);
            ...
            A.CallTo(fakeLogger).Where(call => call.Method.Name == "Log"
              && call.GetArgument<LogLevel>(0) == LogLevel.Information
              && call.GetArgument<EventId>(1) == EventIds.UpsertSearchAndDownloadCacheDataEventStart.ToEventId()
            ...
            A.CallTo(fakeLogger).Where(call => call.Method.Name == "Log"
              && call.GetArgument<LogLevel>(0) == LogLevel.Information
              && call.GetArgument<EventId>(1) == EventIds.UpsertSearchAndDownloadCacheDataEventCompleted.ToEventId()
        ...
        [Test]
        public async Task WhenNoS57CacheDataExistsInUpsertSearchAndDownloadCacheData_ThenReturnResponseFalse()
        {
            var cachingResponse = new FssSearchResponseCache() { };
            A.CallTo(() => fakeAzureTableStorageClient.RetrieveFromTableStorageAsync<FssSearchResponseCache>(A<string>.Ignored, A<string>.Ignored, A<string>.Ignored, A<string>.Ignored)).Returns(cachingResponse);
            A.CallTo(() => fakeAzureStorageService.GetStorageAccountConnectionString(A<string>.Ignored, A<string>.Ignored)).Returns(GetStorageAccountConnectionString());

            await service.UpsertSearchAndDownloadCacheData(GetCacheRequestData(fakeCacheConfiguration.Value.S57CacheBusinessUnit), FakeCorrelationId);
        ...
        [Test]
        public async Task WhenS63CacheDataExistsInUpsertSearchAndDownloadCacheData_ThenReturnResponseTrue()
        {
            A.CallTo(() => fakeAzureTableStorageClient.RetrieveFromTableStorageAsync<FssSearchResponseCache>(A<string>.Ignored, A<string>.Ignored, A<string>.Ignored, A<string>.Ignored)).Returns(GetCacheResponse(fakeCacheConfiguration.Value.S63CacheBusinessUnit));
            A.CallTo(() => fakeAzureStorageService.GetStorageAccountConnectionString(A<string>.Ignored, A<string>.Ignored)).Returns(GetStorageAccountConnectionString());
        ...
        [Test]
        public async Task WhenS57CacheDataExistsInUpsertSearchAndDownloadCacheData_ThenReturnResponseTrue()
        {
        ...
        [Test]
        public async Task WhenUpsertSearchAndDownloadCacheDataCalled_ThenExecuteAzureStorageDeleteAndInsertOperations()
        {
            A.CallTo(() => fakeAzureTableStorageClient.RetrieveFromTableStorageAsync<FssSearchResponseCache>(A<string>.Ignored, A<string>.Ignored, A<string>.Ignored, A<string>.Ignored)).Returns(GetResponseCache(0));
            A.CallTo(() => fakeAzureStorageService.GetStorageAccountConnectionString(A<string>.Ignored, A<string>.Ignored)).Returns(GetStorageAccountConnectionString());
        ...
        private BatchDetail GetBatchWithMultipleFiles()
        {
            return new BatchDetail
            {
                BatchId = "7b4cdf10-adfa-4ed6-b2fe-d1543d8b7272",
                ...
                {
                    new BatchFile { Filename = "test.txt", FileSize = 400, Links = new Common.Models.FileShareService.Response.Links { Get = new Link { Href = "" } } },
                    new BatchFile { Filename = "testCache.txt", FileSize = 600, Links = new Common.Models.FileShareService.Response.Links { Get = new Link { Href = "" } } }

                }
            };
        }
        private FssSearchResponseCache GetResponseCache(int count = 0)
        {
            if (count > 0)
            {
                return new FssSearchResponseCache()
                {
                    ...
                    PartitionKey = "DE416050",
                    RowKey = "2|0",
                    Response = JsonConvert.SerializeObject(GetBatchWithMultipleFiles())
                };
            }
            else
            {
