...
Write-Host "##vso[task.setvariable variable=CacheConfiguration.CacheStorageConnectionString;issecret=true]$($terraformOutput.qc_storage_connection_string.value)"
